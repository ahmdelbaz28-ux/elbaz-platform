...
export default function CourseDetail() {
  ...
  if (!course) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#0a0e17]">
        <p className="text-lg text-[#94a3b8]">{t("error")}</p>
      </div>
    );
  }
  ...
  const outcomes = lang === "ar" && course.learningOutcomesAr
          ...
          <div className="lg:col-span-2">
            ...
            {outcomes && (
              <div className="mb-8 rounded-xl border border-[#1f2d44] bg-[#111827] p-6">
                <h3 className="text-lg font-semibold text-[#f0f4f8]">{t("whatYouWillLearn")}</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="sticky top-24 rounded-xl border border-[#1f2d44] bg-[#111827] p-6">
              ...
              <div className="mt-6 space-y-3">
                <h4 className="text-sm font-semibold text-[#f0f4f8]">{t("thisCourseIncludes")}</h4>
                {[
            ...
            <div className="rounded-xl border border-[#1f2d44] bg-[#111827] p-6">
              <h3 className="mb-4 text-lg font-semibold text-[#f0f4f8]">{t("courseContent")}</h3>
      ...
      {showPayment && (
        ...
        >
          <div className="mx-4 w-full max-w-md rounded-xl border border-[#1f2d44] bg-[#111827] p-6 relative">
            ...
            <h3 className="text-lg font-semibold text-[#f0f4f8]">{t("paymentMethods")}</h3>
