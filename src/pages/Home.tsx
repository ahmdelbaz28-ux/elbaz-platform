...
export default function Home() {
  ...
  const categoryIcons: Record<string, React.ReactNode> = {
    Zap: <ZapIcon className="h-5 w-5 text-[#06b6d4]" />,
  ...
  return (
    <div className="min-h-screen bg-[#0a0e17]">
      ...
      <section className="relative min-h-screen overflow-hidden pt-24">
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse at 20% 30%, rgba(6,182,212,0.08) 0%, transparent 50%)",
            }}
          />
        </div>
                ...
                <Link to={`/courses?category=${cat.id}`}>
                  <div className="group rounded-xl border border-[#1f2d44] bg-[#111827] p-8 transition-all hover:-translate-y-1 hover:border-[rgba(6,182,212,0.35)] hover:shadow-[0_12px_32px_rgba(6,182,212,0.08)]">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[rgba(6,182,212,0.1)]">
                      {categoryIcons[cat.icon] || <ZapIcon className="h-5 w-5 text-[#06b6d4]" />}
                    </div>
              ...
              <SectionReveal key={t.id}>
                <div className="rounded-xl border border-[#1f2d44] bg-[#111827] p-8">
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-[#f0f4f8]">{t.name}</p>
      ...
      {/* ─── CTA Banner ─── */}
      <section className="border-y border-[#1f2d44] py-20"
        style={{ background: "linear-gradient(135deg, rgba(6,182,212,0.08) 0%, rgba(16,185,129,0.05) 100%)" }}
      >
