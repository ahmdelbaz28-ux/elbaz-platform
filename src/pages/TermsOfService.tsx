          ...
          {lang === "en" ? (
            <>
              ...
              <Section title="9. Contact">
                <p>For any questions regarding these Terms of Service, please contact us through our <Link to="/support" className="text-[#06b6d4] hover:underline">Support Center</Link> or via email at contact@ahmedelbaz.com.</p>
              </Section>
            </>
          ) : (
            <>
              ...
              <Section title="٩. التواصل">
                <p>لأي أسئلة بخصوص شروط الاستخدام، يرجى التواصل معنا عبر <Link to="/support" className="text-[#06b6d4] hover:underline">مركز الدعم</Link> أو عبر البريد الإلكتروني contact@ahmedelbaz.com.</p>
              </Section>
            </>
          )}
        </div>
