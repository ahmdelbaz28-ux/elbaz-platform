          ...
          {lang === "en" ? (
            <>
              ...
              <Section title="7. Contact Us">
                <p>For refund inquiries, please contact our support team via <Link to="/support" className="text-[#06b6d4] hover:underline">Support Center</Link> or email billing@ahmedelbaz.com. We aim to resolve all refund requests within 24 hours.</p>
              </Section>
            </>
          ) : (
            <>
              ...
              <Section title="٧. تواصل معنا">
                <p>للاستفسارات عن الاسترداد، تواصل معنا عبر <Link to="/support" className="text-[#06b6d4] hover:underline">مركز الدعم</Link> أو billing@ahmedelbaz.com. نهدف لحل جميع طلبات الاسترداد خلال ٢٤ ساعة.</p>
              </Section>
            </>
          )}
        </div>
