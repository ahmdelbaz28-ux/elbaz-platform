          ...
          {lang === "en" ? (
            <>
              ...
              <Section title="9. Contact">
                <p>For privacy-related inquiries, please contact us through our <Link to="/support" className="text-[#06b6d4] hover:underline">Support Center</Link> or email <a href={`mailto:${contact.email}`} className="text-[#06b6d4] hover:underline">{contact.email}</a>. We will respond to your request within 14 business days.</p>
              </Section>
            </>
          ) : (
            <>
              ...
              <Section title="٩. التواصل">
                <p>للاستفسارات المتعلقة بالخصوصية، تواصل معنا عبر <Link to="/support" className="text-[#06b6d4] hover:underline">مركز الدعم</Link> أو البريد الإلكتروني <a href={`mailto:${contact.email}`} className="text-[#06b6d4] hover:underline">{contact.email}</a>. سنرد على طلبك خلال ١٤ يوم عمل.</p>
              </Section>
            </>
          )}
        </div>
