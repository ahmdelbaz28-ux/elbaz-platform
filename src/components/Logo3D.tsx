...
export default function Logo3D({
  ...
  /* Auto-rotate 360° every 5 seconds using rAF for smooth animation */
  useEffect(() => {
    const ROTATION_PERIOD = 5000; // 5 seconds for full 360°
  ...
  return (
    ...
    >
      ...
      {/* ── 3D Disc: the main rotating logo plate ── */}
      <div
        style={{
          position: 'relative',
          width: px,
          ...
          alignItems: 'center',
          justifyContent: 'center',
          /* Auto Y-rotation + optional mouse tilt */
          transform: `rotateY(${rotation}deg) rotateX(${tilt.x}deg) rotateY(${rotation + tilt.y}deg) scale3d(${isHovered ? 1.1 : 1}, ${isHovered ? 1.1 : 1}, 1)`,
      ...
      >
        ...
        {/* Logo image — counter-rotates to stay readable */}
        <img
          src="/logo.png"
          alt=""
          aria-hidden="true"
